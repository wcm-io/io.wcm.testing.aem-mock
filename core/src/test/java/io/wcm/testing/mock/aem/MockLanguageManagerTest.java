...
public class MockLanguageManagerTest {
    ...
    public void getLanguageRootResources_respectContent() {
        ...
        assertArrayEquals(new String[]{ENGLISH_HOMEPAGE, FRENCH_HOMEPAGE, GERMAN_HOMEPAGE, EMEA_ENGLISH_HOMEPAGE}, resources.stream().map(Resource::getPath).toArray());
        ...
        assertNotNull(resources);
        assertEquals(4, resources.size());
        assertArrayEquals(new String[]{EMEA_ENGLISH_HOMEPAGE, ENGLISH_HOMEPAGE, FRENCH_HOMEPAGE, GERMAN_HOMEPAGE }, resources.stream().map(Resource::getPath).toArray());
